...
//   // Fetch courses and scheduled classes on component mount
//   useEffect(() => {
...
//           `http://localhost:3000/api/scheduledClasses?auth=${localStorage.getItem(
//             "id"
//           )}`
//         );
//         setScheduledClasses(classResponse.data);
//       } catch (error) {
...
//   const isOverlapping = (date, startTime, endTime) => {
//     const selectedDate = new Date(date).toISOString().split("T")[0];

//     return scheduledClasses.some((scheduledClass) => {
//       const scheduledDate = new Date(scheduledClass.date)
//         .toISOString()
//         .split("T")[0];
//       if (scheduledDate === selectedDate) {
//         const scheduledStartTime = scheduledClass.time_start;
//         const scheduledEndTime = scheduledClass.time_to;
...
//     if (isOverlapping(date, time_start, time_to)) {
//       setMessage(
//         "The selected time overlaps with an existing class. Please choose a different time."
//       );
//       return;
//     }
...
//     try {
//       await axios.post(
//         `http://localhost:3000/api/scheduleClass?course=${course}&teacher=${localStorage.getItem(
//           "id"
//         )}`,
//         {
//           date,
